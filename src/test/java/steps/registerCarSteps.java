...
public class registerCarSteps {
    ...
    public void the_car_is_registered() {
    ...
    public void the_car_s_attributes_of_year_license_plate_colour_and_seats_are_stored(int year, String plate, String colour, int seats) {
        Car car = new Car(type, colour, model, plateNum, year, seatNum);
    ...
    public void jo_has_a_car_registered_a_car() {
        jo = new Driver("jo");
    ...
    public void jo_registers_a_new_car() {
